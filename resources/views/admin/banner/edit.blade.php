            ...
            <div class="bg-white p-4">
                ...
                <form action="{{url('admin/banner/update',$banner->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input class="form-control" name="title" value="{{$banner->title}}" type="text" maxlength="255">
                        </div>
                    </div>
                    <div class="row mt-3">
                     <div class="col-3">Describe :</div>
                     <div class="col-8">
                        <textarea type="text" class="form-control  text-sm" name="describe" rows="3" maxlength="255" class="ckeditor">{{$banner->describe}}</textarea>
                     </div>
                 </div>
                    <div class="row mt-3">
